...
const StudioAbout: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre o Estúdio | Soisa Tattoo Studio</title>
        <meta
          name="description"
          content="Conheça o Soisa Tattoo Studio: arte urbana, tatuagem personalizada e piercings com técnica e paixão. Venha agendar sua sessão!"
        />
        <meta
          name="keywords"
          content="tatuagem, piercing, estúdio, grafite, arte urbana, Soisa Tattoo"
        />
        <meta property="og:title" content="Sobre o Estúdio | Soisa Tattoo Studio" />
        <meta
      ...
      <section className="bg-black text-dodger-blue min-h-screen">
        <div className="mt-24" /> {/* Espaço superior para header fixo */}
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 max-w-7xl flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
          {/* Texto */}
          <div className="md:w-1/2 text-left space-y-6 no-font-boost" data-aos="fade-right">
