...
const TattooStudioInfoSection: React.FC = () => {
  ...
  return (
    <section
      className="py-16 px-4 bg-[#0a0a1a] text-white"
      data-aos="fade-up"
    >
      <div className="max-w-4xl mx-auto text-center">
        <h2
          className="text-4xl md:text-5xl font-bold mb-8 text-[#00BFFF]"
        ...
        <p
          className="text-lg md:text-xl mb-6 text-gray-300 italic"
        ...
        >
          ...
          >
            ...
            <a
              ...
              onMouseOver={(e) =>
                (e.currentTarget.style.backgroundColor = "#009cd4")
              }
              onMouseOut={(e) =>
